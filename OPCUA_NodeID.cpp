...
const CStringDictionary::TStringId FORTE_OPCUA_NodeID::scm_anDataInputNames[] = {g_nStringIdQI, g_nStringIdnsIndex, g_nStringIdidentifierType, g_nStringIdidentifier};

const CStringDictionary::TStringId FORTE_OPCUA_NodeID::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdUINT, g_nStringIdUSINT, g_nStringIdANY};

const TForteInt16 FORTE_OPCUA_NodeID::scm_anEIWithIndexes[] = {0, 5};
const TDataIOID FORTE_OPCUA_NodeID::scm_anEIWith[] = {0, 1, 2, 3, 255, 1, 2, 3, 255};
...
const SFBInterfaceSpec FORTE_OPCUA_NodeID::scm_stFBInterfaceSpec = {
  ...
  2,  scm_anEventOutputNames,  0, 0,  4,  scm_anDataInputNames, scm_anDataInputTypeIds,
  0,  0, 0,
